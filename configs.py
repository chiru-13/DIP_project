...
#3x Scaling Configuration
X3_CONF = Config()
X3_CONF.scale_factors = [[1.0, 1.5], [1.5, 2.0], [2.0, 3.0], [3.0, 3.0]]  
X3_CONF.back_projection_iters = [4, 6, 8, 10]  
X3_CONF.input_path = os.path.dirname(__file__) + '/set14'

#4x Scaling Configuration
X4_CONF = Config()
X4_CONF.scale_factors = [[1.0, 2.0], [2.0, 2.5], [2.5, 3.5], [3.5, 4.0], [4.0, 4.0]]  
X4_CONF.back_projection_iters = [6, 8, 10, 12, 14] 
X4_CONF.input_path = os.path.dirname(__file__) + '/set14'
